    ...
    P: Provider,
{
    ...
    pub fn balancer_v2_out(
        ...
        let scaled_amount_in_after_fee =
            Self::sub(scaled_amount_in, Self::mul_up(scaled_amount_in, swap_fee));
